...
| `DB_DEBUG`             | `true`                                                                     | Boolean. If this is set to `true` the query and results of every database operation is logged. This happens irrespective of the `LOG_LEVEL` and can be extremely noisy                    |
